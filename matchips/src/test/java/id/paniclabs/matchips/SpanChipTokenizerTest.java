...
public class SpanChipTokenizerTest extends TestCase {
    ...
    public void testApplyConfiguration_emptyString() {
        ...
        MaterialChipsConfig testConfiguration = createTestChipConfiguration();
    ...
    private MaterialChipsConfig createTestChipConfiguration() {
        return new MaterialChipsConfig(-1, null, -1, -1, -1, -1, -1);
    }
