...
public class MaterialChipsConfig {
    ...
    /**
     * Creates a new MaterialChipsConfig. You can pass in {@code -1} or {@code null} for any of the parameters to indicate that parameter should be
     * ignored.
     *
     ...
     */
    MaterialChipsConfig(int chipSpacing,
