...
public interface ChipTokenizer {
     ...
     * <p>
     *     This will also apply the provided {@link MaterialChipsConfig} to any existing chips in the provided text.
     * </p>
     *
     * @param text              the text in which to search for existing chips to apply the configuration to
     * @param materialChipsConfig a {@link MaterialChipsConfig} containing customizations for the chips produced by this class
     */
    void applyConfiguration(Editable text, MaterialChipsConfig materialChipsConfig);
