package id.paniclabs.matchips.token;
...
import id.paniclabs.matchips.chip.ChipCreator;
 ...
 *         <li>Uses the values passed to {@link #applyConfiguration(Editable, MaterialChipsConfig)} to configure any ChipSpans that get created</li>
 *     </ul>
...
public class SpanChipTokenizer<C extends Chip> implements ChipTokenizer {
    ...
    @Nullable
    private MaterialChipsConfig mMaterialChipsConfig;
    @NonNull
    ...
    @Override
    public void applyConfiguration(Editable text, MaterialChipsConfig materialChipsConfig) {
        mMaterialChipsConfig = materialChipsConfig;
    ...
    private CharSequence terminateToken(C chip) {
        ...
        // Attach the ChipSpan
        if (mMaterialChipsConfig != null) {
            mChipCreator.configureChip(chip, mMaterialChipsConfig);
        }
