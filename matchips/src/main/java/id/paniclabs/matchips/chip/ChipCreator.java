...
public interface ChipCreator<C extends Chip> {
    ...
    /**
     * Applies the given {@link MaterialChipsConfig} to the given {@link Chip}. Use this method to customize the appearance/behavior of a chip before
     * adding it to the text.
     *
     * @param chip              the chip to configure
     * @param materialChipsConfig the configuration to apply to the chip
     */
    void configureChip(@NonNull C chip, @NonNull MaterialChipsConfig materialChipsConfig);
}
